...
-- | when somebody quits
quitCB :: Message.Message a => a -> SeenMap -> ClockTime -> Nick -> Either String SeenMap
...
nickCB :: Message.Message a => a -> SeenMap -> ClockTime -> Nick -> Either String SeenMap
