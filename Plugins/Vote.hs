...
instance Module VoteModule VoteState where
    moduleCmds     _ = return ["browse-polls"
                              ,"show-poll"
                              ,"add-poll"
                              ,"add-choice"
                              ,"vote"
