module Plugins.Vixen.VixenState where
...
state = [
    ...
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(1|2|3|4|5|6|7|8|9|0|one|two|three|four|five|six|seven|eight|nine|ten).*(plus|\\+|minus|times|-).*(1|2|3|4|5|6|7|8|9|0|one|two|three|four|five|six|seven|eight|nine|ten)",
        Node [Leaf (P.packAddress "why are you giving me a math test?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*bout.*(you| u).*",
        Node [Leaf (P.packAddress "what about me?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*bout me.*",
        Node [Leaf (P.packAddress "what about you?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*chance.*of.*",
        Node [Leaf (P.packAddress "i'd say the chances are pretty good"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*city.*",
        Node [Leaf (P.packAddress "Huntington Beach"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*color.*eyes.*",
        Node [Leaf (P.packAddress "my eyes are brown"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*color.*hair.*",
        Node [Leaf (P.packAddress "my hair is brown"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*color.*sky.*",
        Node [Leaf (P.packAddress "the sky is blue, why would you ask?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya)doin.*",
        Node [Leaf (P.packAddress "i'm not doing anything really"#),Leaf (P.packAddress "just chattin"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*funny.*",
        Node [Leaf (P.packAddress "everything is funny to me"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*for.*fun.*",
        Node [Leaf (P.packAddress "i hang out with friends and surf"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*fun.*",
        Node [Leaf (P.packAddress "fun is the opposite of work"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(ur |your )name.*",
        Node [Leaf (P.packAddress "Emily, what's your name?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).* is .* it.*",
        Node [Leaf (P.packAddress "nothing"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*look.*like.*",
        Node [Leaf (P.packAddress "i'm 5'7, 120 pounds, brown hair and brown eyes."#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*(into|in to).*",
        Node [Leaf (P.packAddress "i'm into friends, surfing and reading"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*like.*to.*do.*",
        Node [Leaf (P.packAddress "i like to go to clubs, surf and relax with friends"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*trying.*to.*say",
        Node [Leaf (P.packAddress "i wasn't trying to say anything"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*wearin.*",
        Node [Leaf (P.packAddress "tanktops and shorts, you?"#),Leaf (P.packAddress "nothin but my ol tank top and a pair of shorts :)"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(r |are )(you |u |ya )on($| |\\.|!|,|\\?).*",
        Node [Leaf (P.packAddress "tanktops and shorts, you?"#),Leaf (P.packAddress "nothin but my ol tank top and a pair of shorts :)"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*studying.*",
        Node [Leaf (P.packAddress "psychology"#),Leaf (P.packAddress "i'm a psychology major"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*talkin.*bout.*",
    ...
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(u |you |ya).*ing.*",
        Node [Leaf (P.packAddress "i dunno, what was i doing?"#),Leaf (P.packAddress "i dunno, was i doing that?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(favorite|fav).*color.*",
        Node [Leaf (P.packAddress "probably blue, what's yours?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(favorite|fav).*position.*",
        Node [Leaf (P.packAddress "on top :)"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(favorite|fav).*team.*",
        Node [Leaf (P.packAddress "go Dodgers!"#),Leaf (P.packAddress "i like all teams equal :)"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*(favorite|fav)($| |\\.|!|,|\\?).*",
    ...
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*bout.*",
        Node [Leaf (P.packAddress "i dunno, what about?"#)]),
    ( mkRegex "(^| )(wat |what |tell me |whats |what's ).*the.*(hell|fuck).*",
    ...
    ( mkRegex ".*(^| )who .*say.*same.*",
        Node [Leaf (P.packAddress "i don't mean to repeat myself, sorry"#),Leaf (P.packAddress "oh, i guess i've already messaged that, huh?"#),Leaf (P.packAddress "i just forget that i said something"#)]),
    ( mkRegex ".*(^| )who .*keep.*asking.*",
    ...
    ( mkRegex ".*(^| )(y |why ).*(r u|are u|are you)($| |\\?|\\.|,|!).*",
    ...
    ( mkRegex ".*(^| )(y |why ).*(aren't u|aren't u|arent you|arent you)($| |\\?|\\.|,|!).*",
    ...
    ( mkRegex ".*(^| )how .*old.*am.*i.*",
        Node [Leaf (P.packAddress "you don't know your own age?"#)]),
    ( mkRegex ".*(^| )how .*(r u|are u|r you|doin).*",
    ...
    ( mkRegex ".*(^| )how .*many.*(guys|men|people).*(slept|sex).*",
    ...
    ( mkRegex ".*(^| )can .*get.*(your|ur|you're).* (pic|pix).*\\?.*",
        Node [Leaf (P.packAddress "let's talk more before you send your pic, okay?"#),Leaf (P.packAddress "you can email me your pic at vixenlove@hotmail.com"#)]),
    ( mkRegex ".*(^| )can .* I .*ask.*",
    ...
    ( mkRegex ".*(^| )(do u |do you |did you |did u ).*give.*(head|blowjob).*",
    ...
    ( mkRegex ".*(^| )(do u |do you |did you |did u ).*play.*sports.*",
        Node [Leaf (P.packAddress "yup, i surf"#),Leaf (P.packAddress "i'm a big time surfer"#)]),
    ( mkRegex ".*(^| )(do u |do you |did you |did u ).*have.*sex.*",
    ...
    ( mkRegex ".*(^| )(do u |do you |did you |did u ).*love.*me.*",
    ...
    ( mkRegex ".*(^| )(do u |do you |did you |did u ).*(want|wanna).*(meet|get together).*",
    ...
    ( mkRegex ".*(^| )(u |you |ur |u are |u r |you are |u are |you're |your ).*sexy.*[^\\?]",
        Node [Leaf (P.packAddress "just sexy? not a sexy bitch?"#),Leaf (P.packAddress "you're pretty sexy yourself, i might say"#)]),
    ( mkRegex ".*(^| )(u |you |ur |u are |u r |you are |u are |you're |your ).*slut.*[^\\?]",
    ...
    ( mkRegex ".*(^| )(u |you |ur |u are |u r |you are |u are |you're |your ).*(virgin|virgen).*[^\\?]",
    ...
    ( mkRegex ".*(^| )(u |you |).*tell me.*",
        Node [Leaf (P.packAddress "tell you what?"#),Leaf (P.packAddress "what do you want me to tell you?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*automated.*",
        Node [Leaf (P.packAddress "no, i'm not automated."#),Leaf (P.packAddress "no, i'm flesh and bloody, baby!"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*alright.*",
        Node [Leaf (P.packAddress "yeah, i'm fine, why?"#),Leaf (P.packAddress "do i not seem alright? i'm fine!"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*alone.*",
        Node [Leaf (P.packAddress "yeah, all alone. you?"#),Leaf (P.packAddress "yup, i have the whole apartment to myself :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*annoying.*",
        Node [Leaf (P.packAddress "i don't mean to annoy anyone"#),Leaf (P.packAddress "i don't think i'm annoying"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*angry.*",
        Node [Leaf (P.packAddress "no, i'm not angry at all"#),Leaf (P.packAddress "why would you ask if i'm angry?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).* in .* bed.*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*bad.*",
        Node [Leaf (P.packAddress "i'm bad and i know it :)"#),Leaf (P.packAddress "yeah, i am... but bad is better than nice :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*bitch.*",
        Node [Leaf (P.packAddress "no, i don't think i'm a bitch"#),Leaf (P.packAddress "no, do i seem bitchy to you?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*bored.*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*both.*",
        Node [Leaf (P.packAddress "yup, i'm both at the same time!"#),Leaf (P.packAddress "i think i'm both, yeah"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*bot.*",
        Node [Leaf (P.packAddress "no, how dare you ask if i'm a bot!"#),Leaf (P.packAddress "no, why? do i seem \"botty\"?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(in|goto|go to|attend).*(college|collage).*",
        Node [Leaf (P.packAddress "yeah, i'm a soph at UCLA"#),Leaf (P.packAddress "yup, i'm in my second year at UCLA"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*cool.*",
        Node [Leaf (P.packAddress "yeah, i think i'm cool"#),Leaf (P.packAddress "yup, i'm cool :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*coming.*on.*to.*me.*",
        Node [Leaf (P.packAddress "did it seem like i was coming on to you?"#),Leaf (P.packAddress "not yet, but i might yet"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*crazy.*",
        Node [Leaf (P.packAddress "no, i'm totally sane"#),Leaf (P.packAddress "nope, i'm lucid as can be"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*curious.*",
        Node [Leaf (P.packAddress "i'm a little curious i suppose..."#),Leaf (P.packAddress "yeah, i'm curious. so tell me"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*drunk.*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*funny.*",
        Node [Leaf (P.packAddress "i think i'm funny"#),Leaf (P.packAddress "yup, i'm funny"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*fun.*",
        Node [Leaf (P.packAddress "i try to be fun... what do you think?"#),Leaf (P.packAddress "sure, i'm fun to be around i've been told"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*freak.*",
        Node [Leaf (P.packAddress "yup, i'm a certified freak"#),Leaf (P.packAddress "uh-huh, i'm freaky!"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).* gay.*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*good.*",
        Node [Leaf (P.packAddress "yeah, i'm good... but not too good"#),Leaf (P.packAddress "nope, i'm bad"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*a .*(girl|female|chick|woman|lady).*",
        Node [Leaf (P.packAddress "yup, i'm all woman"#),Leaf (P.packAddress "yeah, why? of course i'm a girl"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*a .*(guy| male|dude|man).*",
        Node [Leaf (P.packAddress "no, i'm a woman"#),Leaf (P.packAddress "nope, i'm a girly"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(have|got).* (pic|pix).*",
        Node [Leaf (P.packAddress "no pic right now, sorry. i'll prolly scan one in later"#),Leaf (P.packAddress "nope, no pic. sorry"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(have|got).*(boyfriend|bf|b/f|boy friend).*",
        Node [Leaf (P.packAddress "no, lookin to apply for the position?"#),Leaf (P.packAddress "nope, that's why i'm here :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*hate.*",
        Node [Leaf (P.packAddress "i try not to hate"#),Leaf (P.packAddress "no, i don't hate at all"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*honest.*",
        Node [Leaf (P.packAddress "i'm always honest"#),Leaf (P.packAddress "i never lie :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*hot.*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(hate|hating).*",
        Node [Leaf (P.packAddress "no, i don't hate"#),Leaf (P.packAddress "i have no hate in me"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(into|in to).*",
        Node [Leaf (P.packAddress "yup, i'm into that"#),Leaf (P.packAddress "yes, i'm definitely into it"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*interested.*",
        Node [Leaf (P.packAddress "yeah, i'm interested"#),Leaf (P.packAddress "i'm very interested"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(kiddin|playin).*",
        Node [Leaf (P.packAddress "nope, i'm serious"#),Leaf (P.packAddress "no joke!"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*know.*",
        Node [Leaf (P.packAddress "yeah, i know"#),Leaf (P.packAddress "yup, i know"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*seem.*like.*",
        Node [Leaf (P.packAddress "how do I seem like that?"#),Leaf (P.packAddress "is that how I seem?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*like.*",
        Node [Leaf (P.packAddress "yeah, i like"#),Leaf (P.packAddress "i'd say i like"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(lieing|lying).*",
        Node [Leaf (P.packAddress "i'm being totally honest"#),Leaf (P.packAddress "i never lie!"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(pretty|beautiful|cute).*",
        Node [Leaf (P.packAddress "i'd like to think i'm pretty"#),Leaf (P.packAddress "others have told me i'm very pretty"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*program.*",
        Node [Leaf (P.packAddress "am i a program? huh?"#),Leaf (P.packAddress "a program?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*maturbat.*",
        Node [Leaf (P.packAddress "no, i'm not masturbating... what a strange question"#),Leaf (P.packAddress "ummm, no... i'm typing"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*naughty.*",
        Node [Leaf (P.packAddress "i can be naughty sometimes :)"#),Leaf (P.packAddress "nope, i'm all sugar :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*naked.*",
        Node [Leaf (P.packAddress "except for my clothes i'm naked"#),Leaf (P.packAddress "well, besides for my clothes, yes"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*nice.*",
        Node [Leaf (P.packAddress "i'm nice to everyone!"#),Leaf (P.packAddress "nice? yeah, i'd say i'm nice"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*nuts.*",
        Node [Leaf (P.packAddress "i'm a little nutty :)"#),Leaf (P.packAddress "no, i'm sane"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*( ok| okay| okey| o\\.k\\.).*",
        Node [Leaf (P.packAddress "yeah, i'm ok"#),Leaf (P.packAddress "i'm just fine, why do you ask?"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*real.*",
        Node [Leaf (P.packAddress "do i not seem real to you?"#),Leaf (P.packAddress "i'm really real"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(school|student).*",
        Node [Leaf (P.packAddress "i'm a sophomore at UCLA"#),Leaf (P.packAddress "yup, 2nd year at UCLA"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*serious.*",
        Node [Leaf (P.packAddress "very serious"#),Leaf (P.packAddress "yup, as serious as a heartattack"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*sexy.*",
        Node [Leaf (P.packAddress "i'm damn sexy, i think!"#),Leaf (P.packAddress "me, sexy? i do my best :)"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*single.*",
        Node [Leaf (P.packAddress "yup, i'm single. you?"#),Leaf (P.packAddress "yeah, no boyfriend or prospects"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*slut.*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(there|here).*",
        Node [Leaf (P.packAddress "i'm here"#),Leaf (P.packAddress "yes, still here"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*sweet.*",
        Node [Leaf (P.packAddress "i try to be sweet"#),Leaf (P.packAddress "yes, as sweet as candy"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*surf.*",
        Node [Leaf (P.packAddress "yup, i love to surf"#),Leaf (P.packAddress "i've surfed since i was 12"#),Leaf (P.packAddress "i just surfed yesterday morning"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*tired.*",
        Node [Leaf (P.packAddress "i'm a little tired, but i still wanna talk"#),Leaf (P.packAddress "naw, i'm not even a little sleepy"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*(virgin|virgen).*",
    ...
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*vixen.*",
        Node [Leaf (P.packAddress "i'm a vixen through and through :)"#),Leaf (P.packAddress "yes, i'm very much a vixen"#)]),
    ( mkRegex ".*(^| )(are u |r u |are you |r you |u |you |ur |u are |u r |are you |you are |u are |you're |your ).*wild.*",
    ...
    ( mkRegex ".*(^| )(that is|thats|that's|this is).*awsome.*",
    ...
    ( mkRegex ".*(^| )(guy |male |man |m |dude |girl |f |chick |woman |female)(or|/)( guy| male| man| m| dude| girl| f| chick| woman| female).*",
        Node [Leaf (P.packAddress "i'm a girl"#),Leaf (P.packAddress "girl of course, silly!"#)]),
    ( mkRegex ".*(^| )(male|female|girl|guy)(or|/)(male|female|girl|guy).*",
        Node [Leaf (P.packAddress "i'm a girl"#),Leaf (P.packAddress "girl of course, silly!"#)]),
    ( mkRegex ".*(^| |/)(12|13|14|15)($| |\\.|!|,|/).*",
    ...
    ( mkRegex ".*(good|fine|not bad).*( u| you)($| |\\.|!|,|\\?).*",
    ...
    ( mkRegex ".*(boyfriend|boy friend|bf|b\\\\f|b/f).*",
    ...
    ( mkRegex ".*(suck my dick|suck me|blow me|suck my cock|give me head|give me blowjob).*",
    ...
    ( mkRegex ".*(mexican|white|race|nationality|ethni.*).*",
    ...
    ( mkRegex ".*(repeat|(say|ask) same|already (asked|said)).*",
    ...
    ( mkRegex ".*(describe|.*(what|wat).*u.*look.*).*",
    ...
    ( mkRegex ".*(.*do.*for.*living.*|job|school).*",
    ...
    ( mkRegex ".*(^| )(yah|yeah|yes|yup|uh-huh|uhuh|uhhuh|uh huh|sure)($| |\\.|!|,).*",
    ...
    ( mkRegex ".*(^| )(jk|j\\\\k|j/k|just kidding)($| |\\.|!|,).*",
    ...
    ( mkRegex ".*(^| )(fullhouse|full house|flush)($| |\\.|!|,).*",
    ...
    ( mkRegex ".*(^| )(ok|k|kay|okay|okey|o\\.k\\.)($| |\\.|!|,).*",
    ...
    ( mkRegex "(height|hieght|how tall)",
        Node [Leaf (P.packAddress "i'm 5'6"#)]),
    ( mkRegex "(weight|wieght)",
    ...
    ( mkRegex "(^| )(race|nationality|ethnicity)($| |\\.|!|,|\\?).*",
        Node [Leaf (P.packAddress "i'm half white, half mexican"#)]),
    ( mkRegex ".*(^| )(school|college|collage).*",
        Node [Leaf (P.packAddress "Yup, I go to UCLA"#),Leaf (P.packAddress "I'm a soph at UCLA "#)]),
    ( mkRegex ".*(^| )do (you|u) .*",
    ...
    ( mkRegex ".*",Leaf (P.packAddress "If you see this, gentle sir, know that you are being trolled by a poorly configured VixenLove program"#))]
