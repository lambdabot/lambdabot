...
module Plugins.Lambda.LMEngine (
     evaluate,
     define,
     Environment,
     resume
...
import Plugins.Lambda.ArithTerm
import Plugins.Lambda.LambdaTerm
import Plugins.Lambda.RelTerm
import Plugins.Lambda.ListTerm
import Plugins.Lambda.LMParser
