...
--
module Plugins.PlModule (theModule) where

import IRC

import Plugins.PlModule.Common          (TopLevel, mapTopLevel, getExpr)
import Plugins.PlModule.Parser          (parsePF)
import Plugins.PlModule.PrettyPrinter   (Expr)
import Plugins.PlModule.Transform       (transform, optimize)
