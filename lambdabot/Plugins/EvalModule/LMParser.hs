...
--
module Plugins.EvalModule.LMParser (parseTerm,Term(..)) where

import Plugins.EvalModule.LangPack
import Plugins.EvalModule.ArithTerm (ArithTerm(..))
import Plugins.EvalModule.LambdaTerm (LambdaTerm(..))
import Plugins.EvalModule.RelTerm (RelTerm(..))
import Plugins.EvalModule.ListTerm (ListTerm(..))
